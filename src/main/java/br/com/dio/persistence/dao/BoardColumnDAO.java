...
public class BoardColumnDAO {
    ...
    public List<BoardColumnEntity> findBoardById(final Long boardId) throws SQLException{
    ...
    public List<BoardColumnDTO> findBoardByIdWithDetails(Long boardId) throws SQLException{
    ...
    public Optional<BoardColumnEntity> findById(final Long boardId) throws SQLException{
        ...
        try (var statement = connection.prepareStatement(sql)) {
            ...
            if (resultSet.next()) {
                ...
                do {
                    if (nonNull(resultSet.getString("c.title"))) {
                        break;
                    }
