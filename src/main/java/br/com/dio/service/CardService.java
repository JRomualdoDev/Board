...
import br.com.dio.dto.BoardColumnsInfoDTO;
...
public class CardService {
    ...
    public void moveToNextColumn(final Long cardId, final List<BoardColumnsInfoDTO> boardColumnsInfo) throws SQLException {
        try{
            var dao = new CardDAO(connection);
    ...
    public void cancel(final Long cardId, final Long cancelColumnId ,
                       final List<BoardColumnsInfoDTO> boardColumnsInfo) throws SQLException{
        try{
            var dao = new CardDAO(connection);
            var optional = dao.findById(cardId);
            var dto = optional.orElseThrow(
    ...
    public void block(final Long id, final String reason, final List<BoardColumnsInfoDTO> boardColumnsInfo) throws SQLException {
        try{
            var dao = new CardDAO(connection);
